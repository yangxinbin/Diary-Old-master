      ...
      //  setColor(holder);
        ...
        if (!image.equals("n")) {
            ...
            if (file.exists()) {
                ...
                Picasso.with(context).load(file).into(holder.ivShow);
                //holder.ivShow.setImageBitmap(bitmap);
            } else {
                holder.ivShow.setVisibility(View.GONE);
            }
        }
        holder.tvDate.setText(String.format(Constants.FORMAT, diaryBean.getDate(),diaryBean.getWeek()));
        holder.tvWeather.setText("天气:"+diaryBean.getWeather());
...
/*    private void setColor(DiaryHolder holder) {
    ...
    class DiaryHolder extends RecyclerView.ViewHolder {
        ...
        private TextView tvTitle, tvContent, tvDate, tvWeather;
       // private View viewColor;
        ...
        DiaryHolder(View itemView) {
            ...
            tvWeather = (TextView) itemView.findViewById(R.id.diary_item_tv_weather);
